...
(if (probe_file (path-append ked_diphone_dir "group/kedlpc16k.group"))
    (defvar ked_index_file "/home/omubin/Desktop/festival/festival/lib/voices/english/ked_diphone/group/kedlpc16k.group")
      ;;;(path-append ked_diphone_dir "group/kedlpc16k.group"))
    (defvar ked_index_file "/home/omubin/Desktop/festival/festival/lib/voices/english/ked_diphone/group/kedlpc8k.group"))
...
;; ( [ j ] = sh ) ;; the best we can do with these diphones
 ( [ j ] = jh ) ;; the best we can do with these diphones
 ( [ k ] = k )
 ( [ l ] = l )
 ( [ m ] = m )
 ( [ n ] = n )
